const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModelPerformanceTest-CWLppznw.js","assets/tfjs-DSq-hcCs.js","assets/ModelPerformanceTest-CDt8YnXr.css"])))=>i.map(i=>d[i]);
let Eu, Tt, sn, it, En, Mu, Pe, Tu, Nn, Pu, bu, hc, Su, Cu, Rl, to, Li, Fs, pn, Fn, kn, uc, ei, xu, Au, ji, dc, pf, Ae, Ou, lf, To, ef, Iu, eo, ke, yc, si, ie, Fo, ye, gs, gl, Hn, Sl, Ru, vu, Dn, nl, ol, Ct, Te, Bt, qn, wu, pc;
let __tla = (async () => {
  (function() {
  ...
  bu = function(e) {
    ...
    return t && !le(t) && (e.class = Fn(t)), n && (e.style = Nn(n)), e;
  };
  ...
  function jn(e, t) {
    ...
    if (n = te(e), s = te(t), n || s) {
      ...
      for (const i in e) {
        ...
        if (l && !c || !l && c || !jn(e[i], t[i])) return false;
      }
    }
  ...
  ji = (e) => le(e) ? e : e == null ? "" : D(e) || te(e) && (e.toString === Gr || !k(e.toString)) ? Yr(e) ? ji(e.value) : JSON.stringify(e, Xr, 2) : String(e);
  ...
  function al(e, t, n = ee) {
    ...
    return l && l(F), u = new no(d), u.scheduler = i ? () => i(F, false) : F, m = (T) => ul(T, false, u), p = u.onStop = () => {
      const T = bn.get(u);
      if (T) {
        if (c) c(T, 4);
  ...
  Ru = function(e, t, n = {}, s, r) {
    ...
    const i = o && jo(o(n)), l = n.key || i && i.key, c = gs(Pe, {
      key: (l && !Ie(l) ? l : `_${t}`) + ""
    }, i || [], i && e._ === 1 ? 64 : -2);
  ...
  function jo(e) {
    return e.some((t) => Xt(t) ? !(t.type === it || t.type === Pe && !jo(t.children)) : true) ? e : null;
  }
  const as = (e) => e ? ti(e) ? Bn(e) : as(e.parent) : null, kt = de(/* @__PURE__ */ Object.create(null), {
    ...
    $watch: (e) => tc.bind(e)
  }), Yn = (e, t) => e !== ee && !e.__isScriptSetup && Q(e, t), Fl = {
    get({ _: e }, t) {
  ...
  function jl(e) {
    ...
    if (hs = true, o) for (const U in o) {
      const z = o[U], Ue = k(z) ? z.bind(n, n) : k(z.get) ? z.get.bind(n, n) : Ke, Xe = !k(z) && k(z.set) ? z.set.bind(n) : Ke, Fe = Ae({
        get: Ue,
        set: Xe
      });
    ...
    if (oe(xl, d), oe(Sl, p), oe(wl, m), oe(El, S), oe(yl, w), oe(bl, V), oe(Ol, K), oe(Al, ne), oe(Pl, W), oe(Rl, M), oe(Fo, T), oe(Cl, $), D(Y)) if (Y.length) {
  ...
  function Ql(e, t) {
    ...
    const { insert: s, remove: r, patchProp: o, createElement: i, createText: l, createComment: c, setText: h, setElementText: u, parentNode: d, nextSibling: p, setScopeId: m = Ke, insertStaticContent: S } = e, w = (f, a, g, _ = null, v = null, b = null, C = void 0, R = null, E = !!a.dynamicChildren) => {
      if (f === a) return;
      f && !jt(f, a) && (_ = y(f), ve(f, v, b, true), f = null), a.patchFlag === -2 && (E = false, a.dynamicChildren = null);
      ...
      let H;
      if (g && ht(g, false), (H = j.onVnodeBeforeUpdate) && $e(H, g, a, f), L && at(a, f, g, "beforeUpdate"), g && ht(g, true), (A.innerHTML && j.innerHTML == null || A.textContent && j.textContent == null) && u(R, ""), x ? Y(f.dynamicChildren, x, R, g, _, Xn(a, v), b) : C || z(f, a, R, null, g, _, Xn(a, v), b, false), E > 0) {
      ...
      for (let R = 0; R < a.length; R++) {
        const E = f[R], x = a[R], L = E.el && (E.type === Pe || !jt(E, x) || E.shapeFlag & 70) ? d(E.el) : g;
      ...
      H && (R = R ? R.concat(H) : H), f == null ? (s(x, g, _), s(L, g, _), K(a.children || [], g, L, v, b, C, R, E)) : A > 0 && A & 64 && j && f.dynamicChildren ? (Y(f.dynamicChildren, j, g, v, b, C, R), (a.key != null || v && a === v.subTree) && $s(f, a, true)) : z(f, a, g, L, v, b, C, R, E);
      ...
      const R = () => {
        if (f.isMounted) {
          let { next: A, bu: j, u: H, parent: q, vnode: se } = f;
          {
            const Le = zo(f);
            if (Le) {
          ...
          let X = A, we;
          ht(f, false), A ? (A.el = se.el, U(f, A, C)) : A = se, j && hn(j), (we = A.props && A.props.onVnodeBeforeUpdate) && $e(we, q, A, se), ht(f, true);
          const xe = lr(f), je = f.subTree;
          f.subTree = xe, w(je, xe, d(je.el), y(je), f, v, b), A.el = xe.el, X === null && lc(f, xe.el), H && ge(H, v), (we = A.props && A.props.onVnodeUpdated) && ge(() => $e(we, q, A, se), v);
        } else {
          let A;
          const { el: j, props: H } = a, { bm: q, m: se, parent: X, root: we, type: xe } = f, je = At(a);
          ht(f, false), q && hn(q), !je && (A = H && H.onVnodeBeforeMount) && $e(A, X, a), ht(f, true);
          {
            we.ce && we.ce._injectChildStyle(xe);
            const Le = f.subTree = lr(f);
            w(null, Le, g, _, f, v, b), a.el = Le.el;
          }
          if (se && ge(se, v), !je && (A = H && H.onVnodeMounted)) {
            const Le = a;
            ge(() => $e(A, X, Le), v);
          }
      ...
      L.i = f, L.id = f.uid, E.scheduler = () => js(L), ht(f, true), x();
    }, U = (f, a, g) => {
      a.component = f;
      ...
      for (; x <= A && x <= j; ) {
        ...
        if (jt(H, q)) w(H, q, g, null, v, b, C, R, E);
        else break;
        x++;
      }
      for (; x <= A && x <= j; ) {
        const H = f[A], q = a[j] = E ? nt(a[j]) : Ve(a[j]);
        if (jt(H, q)) w(H, q, g, null, v, b, C, R, E);
        else break;
        A--, j--;
      }
      if (x > A) {
        if (x <= j) {
          ...
          for (; x <= j; ) w(null, a[x] = E ? nt(a[x]) : Ve(a[x]), g, q, v, b, C, R, E), x++;
        }
        ...
        for (x = H; x <= A; x++) {
          ...
          else for (X = q; X <= j; X++) if (Nt[X - q] === 0 && jt(Ee, a[X])) {
            De = X;
            break;
          }
          De === void 0 ? ve(Ee, v, b, true) : (Nt[De - q] = x + 1, De >= Le ? Le = De : je = true, w(Ee, a[De], g, null, v, b, C, R, E), we++);
        }
        const Us = je ? Xl(Nt) : Et;
        for (X = Us.length - 1, x = xe - 1; x >= 0; x--) {
          const Ee = q + x, De = a[Ee], Ws = Ee + 1 < L ? a[Ee + 1].el : _;
          Nt[x] === 0 ? w(null, De, g, Ws, v, b, C, R, E) : je && (X < 0 || x !== Us[X] ? Fe(De, g, Ws, 2) : X--);
        }
      }
    }, Fe = (f, a, g, _, v = null) => {
      const { el: b, type: C, transition: R, children: E, shapeFlag: x } = f;
      if (x & 6) {
        Fe(f.component.subTree, a, g, _);
        return;
      }
      if (x & 128) {
      ...
      if (C === Pe) {
        s(b, a, g);
        for (let A = 0; A < E.length; A++) Fe(E[A], a, g, _);
        s(f.anchor, a, g);
        return;
      }
      if (C === Zn) {
      ...
      if (_ !== 2 && x & 1 && R) if (_ === 0) R.beforeEnter(b), s(b, a, g), ge(() => R.enter(b), v);
        ...
        const { leave: A, delayLeave: j, afterLeave: H } = R, q = () => s(b, a, g), se = () => {
          A(b, () => {
            q(), H && H();
          });
        };
  ...
  function lr(e) {
    ...
    if (M && w !== false) {
      ...
      T.length && B & 7 && (o && T.some(Es) && (M = oc(M, o)), F = Tt(F, M, false, true));
    }
    return n.dirs && (F = Tt(F, null, false, true), F.dirs = F.dirs ? F.dirs.concat(n.dirs) : n.dirs), n.transition && Ls(F, n.transition), I = F, xn(V), I;
  }
  const rc = (e) => {
    let t;
  ...
  function ac(e, t = null, n = null, s = 0, r = null, o = false) {
    ...
    if (Ec(e) && (e = e.__vccOpts), t) {
      ...
      l && !le(l) && (t.class = Fn(l)), te(c) && (Ns(c) && !D(c) && (c = de({}, c)), t.style = Nn(c));
    }
  ...
  pc = function(...e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const s = e[n];
      for (const r in s) if (r === "class") t.class !== s.class && (t.class = Fn([
        t.class,
        s.class
      ]));
  ...
  function Bn(e) {
    return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(vo(Fs(e.exposed)), {
      get(t, n) {
  ...
  const Sr = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, Bc = (e, t, n, s, r, o) => {
    const i = r === "svg";
    t === "class" ? Tc(e, s, i) : t === "style" ? Fc(e, n, s) : An(t) ? Es(t) || Dc(e, t, n, s, o) : (t[0] === "." ? (t = t.slice(1), true) : t[0] === "^" ? (t = t.slice(1), false) : Uc(e, t, s, i)) ? (br(e, t, s), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && yr(e, t, s, i, o, t !== "value")) : e._isVueCE && (/[A-Z]/.test(t) || !le(s)) ? br(e, Te(t), s, o, t) : (t === "true-value" ? e._trueValue = s : t === "false-value" && (e._falseValue = s), yr(e, t, s, i));
  };
  function Uc(e, t, n, s) {
  ...
  function Er(e, t) {
    ...
    if (!(n && !s && !On(t))) {
      for (let r = 0, o = e.options.length; r < o; r++) {
        ...
        if (n) if (s) {
          const c = typeof l;
          c === "string" || c === "number" ? i.selected = t.some((h) => String(h) === String(l)) : i.selected = Fi(t, l) > -1;
  ...
  function of(e, t, n, s) {
    ...
    function h() {
      ...
      return et(u, o, Object.keys(i || {}).reduce((d, p) => (d[p] = Fs(Ae(() => {
        Un(n);
        const m = n._s.get(e);
        return i[p].call(m, m);
      })), d), {}));
  ...
  function rs(e, t, n = "/") {
    ...
    const l = t.indexOf("#");
    let c = t.indexOf("?");
    return l < c && l >= 0 && (c = -1), c > -1 && (s = t.slice(0, c), o = t.slice(c + 1, l > -1 ? l : t.length), r = e(o)), l > -1 && (s = s || t.slice(0, l), i = t.slice(l, t.length)), s = Ff(s ?? t, n), {
      fullPath: s + (o && "?") + o + i,
      path: s,
      query: r,
      hash: en(i)
  ...
  function tu(e, t) {
    ...
    function o(d, p, m) {
      ...
      for (const T of I) {
        ...
        if (M = eu(T, p, V), m ? m.alias.push(M) : (F = F || M, F !== M && F.alias.push(M), S && d.name && !$r(M) && i(d.name)), vi(M) && c(M), w.children) {
          const ne = w.children;
    ...
    function h(d, p) {
      ...
      if ("name" in d && d.name) {
        ...
        V = m.record.name, S = J(Lr(p.params, m.keys.filter((F) => !F.optional).concat(m.parent ? m.parent.keys.filter((F) => F.optional) : []).map((F) => F.name)), d.params && Lr(d.params, m.keys.map((F) => F.name))), w = m.stringify(S);
      } else if (d.path != null) w = d.path, m = n.find((F) => F.re.test(w)), m && (S = m.parse(w), V = m.record.name);
      else {
        if (m = p.name ? s.get(p.name) : n.find((F) => F.re.test(p.path)), !m) throw It(1, {
          location: d,
          currentLocation: p
        });
  ...
  function mu(e) {
    ...
    function W(y, O) {
      ...
      return !f && If(s, N, P) && (v = It(16, {
        to: _,
        from: N
      }), Fe(N, N, true, false)), (v ? Promise.resolve(v) : Y(_, N)).catch((b) => qe(b) ? qe(b, 2) ? b : Xe(b) : z(b, _, N)).then((b) => {
        if (b) {
    ...
    function Se(y, O, P, N, Z) {
      ...
      P && (N || a ? r.replace(y.fullPath, J({
        scroll: a && g && g.scroll
      }, Z)) : r.push(y.fullPath, Z)), c.value = y, Fe(y, O, P, a), Xe();
    }
    let be;
    function ut() {
    ...
    routes: [
      {
        path: "/",
        name: "home",
        component: () => pf(() => import("./ModelPerformanceTest-CWLppznw.js").then(async (m) => {
          await m.__tla;
          return m;
        }).then((e) => e.ap), __vite__mapDeps([0,1,2]))
      }
    ]
  }), Bs = Yc(af);
  Bs.use(ef());
