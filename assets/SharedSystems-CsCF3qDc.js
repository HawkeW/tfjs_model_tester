...
let __tla = Promise.all([
  ...
  const pe = class A extends Fe {
    constructor(e) {
      e = {
        ...A.defaultOptions,
        ...e
      }, super(e), this.enabled = true, this._state = he.for2d(), this.blendMode = e.blendMode, this.padding = e.padding, typeof e.antialias == "boolean" ? this.antialias = e.antialias ? "on" : "off" : this.antialias = e.antialias, this.resolution = e.resolution, this.blendRequired = e.blendRequired, this.clipToViewport = e.clipToViewport, this.addResource("uTexture", 0, 1);
    }
    apply(e, t, r, s) {
...
`;
  class rt extends Ze {
    constructor(e) {
      const { sprite: t, ...r } = e, s = new He(t.texture), n = new re({
        uFilterMatrix: {
          value: new v(),
          type: "mat3x3<f32>"
        },
  ...
  const H = class me {
    constructor(e, t) {
      var _a, _b;
      this.state = he.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, (_b = (_a = this._adaptor).init) == null ? void 0 : _b.call(_a, this);
    }
    static getBatcher(e) {
  ...
  let ve = H;
  D.handleByMap(u.Batcher, ve._availableBatchers);
  D.add(se);
  let st;
  Bt = {
    name: "texture-bit",
    ...
    execute(e) {
      ...
      if (e.action === "pushMaskBegin") {
        ...
        if (s.inverse = e.inverse, r) {
          ...
          const n = Le(e.mask.mask, true, st);
        ...
        r && T.returnTexture(s.filterTexture), g.return(s.filterEffect);
      }
    }
    destroy() {
  ...
  At = function(a, e) {
    for (const t in a.attributes) {
      ...
      s ? (r.format ?? (r.format = s.format), r.offset ?? (r.offset = s.offset), r.instance ?? (r.instance = s.instance)) : ne(`Attribute ${t} is not present in the shader, but is present in the geometry. Unable to infer attribute details.`);
    }
    nt(a);
  };
  function nt(a) {
    ...
    for (const n in t) {
      const i = t[n];
      i.stride ?? (i.stride = r[i.buffer.uid]), i.start ?? (i.start = s[i.buffer.uid]), s[i.buffer.uid] += $(i.format).stride;
    }
  }
  x = [];
  x[f.NONE] = void 0;
  ...
  It = class {
    ...
    _systemCheck() {
      if (!ze()) throw new Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.");
    }
...
`);
  ...
  const Te = class ye {
    constructor(e = {}) {
      if (this.uid = S("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = false, this._size = new Float32Array(2), this._managedColorTextures = false, e = {
        ...ye.defaultOptions,
        ...e
      }, this.stencil = e.stencil, this.depth = e.depth, this.isRoot = e.isRoot, typeof e.colorTextures == "number") {
        this._managedColorTextures = true;
        for (let t = 0; t < e.colorTextures; t++) this.colorTextures.push(new M({
          width: e.width,
          height: e.height,
  ...
  Dt = class {
    constructor(e) {
      this.rootViewPort = new w(), this.viewport = new w(), this.onRenderTargetChange = new Ve("onRenderTargetChange"), this.projectionMatrix = new v(), this.defaultClearColor = [
        0,
        0,
        0,
        0
    ...
    _initRenderTarget(e) {
      let t = null;
      return U.test(e) && (e = be(e).source), e instanceof I ? t = e : e instanceof M && (t = new I({
        colorTextures: [
          e
        ]
      }), U.test(e.source.resource) && (t.isRoot = true), e.once("destroy", () => {
  ...
  Ot = class extends Ne {
    constructor({ buffer: e, offset: t, size: r }) {
      super(), this.uid = S("buffer"), this._resourceType = "bufferResource", this._touched = 0, this._resourceId = S("resource"), this._bufferResource = true, this.destroyed = false, this.buffer = e, this.offset = t | 0, this.size = r, this.buffer.on("change", this.onBufferChange, this);
    }
    onBufferChange() {
  ...
  class Ce {
    ...
    _addRenderableCacheAsTexture(e, t) {
      const r = e._batchableRenderGroup ?? (e._batchableRenderGroup = g.get(fe));
  ...
  function Se(a, e = false) {
    ...
    for (const s in t) {
      ...
      for (let d = 0; d < l; d++) {
        const c = o[d];
        c.parentRenderGroup === a && c.relativeRenderGroupDepth === n && Me(c, r, 0);
      }
      E(o, l), i.index = 0;
    }
  ...
  function ct(a) {
    ...
    if (a.renderGroupParent) {
      ...
      a.worldTransform.appendFrom(e.relativeGroupTransform, r.worldTransform), a.worldColor = ie(e.groupColor, r.worldColor), t = e.groupAlpha * r.worldAlpha;
  ...
  function Me(a, e, t) {
    ...
    const s = a.parent;
    if (s && !s.renderGroup ? (t |= a._updateFlags, a.relativeGroupTransform.appendFrom(r, s.relativeGroupTransform), t & X && Q(a, s, t)) : (t = a._updateFlags, a.relativeGroupTransform.copyFrom(r), t & X && Q(a, dt, t)), !a.renderGroup) {
      const n = a.children, i = n.length;
      for (let d = 0; d < i; d++) Me(n[d], e, t);
  ...
  function Q(a, e, t) {
    if (t & le) {
      a.groupColor = ie(a.localColor, e.groupColor);
  ...
  const L = class Re {
    constructor() {
      this.clearBeforeRender = true, this._backgroundColor = new de(0), this.color = this._backgroundColor, this.alpha = 1;
    }
    init(e) {
      e = {
        ...Re.defaultOptions,
  ...
  class Be {
    constructor(e) {
      this._isAdvanced = false, this._filterHash = /* @__PURE__ */ Object.create(null), this._renderer = e, this._renderer.runners.prerender.add(this);
    }
    prerender() {
    ...
    _beginAdvancedBlendMode(e) {
      ...
      if (!y[t]) {
        ne(`Unable to assign BlendMode: '${t}'. You may want to include: import 'pixi.js/advanced-blend-modes'`);
        return;
      }
      let r = this._filterHash[t];
      r || (r = this._filterHash[t] = new ae(), r.filters = [
        new y[t]()
      ]);
      const s = {
        renderPipeId: "filter",
  ...
  const R = {
    ...
    async base64(e) {
      e = this._normalizeOptions(e, Ue.defaultImageOptions);
  ...
  W.defaultImageOptions = {
    format: "png",
    quality: 1
  };
  let mt = W;
  const vt = new w(), gt = new O(), _t = [
    0,
    0,
    0,
    0
  ...
  class Ae {
    ...
    generateTexture(e) {
      ...
      let n = e.clearColor;
      n ? n = Array.isArray(n) && n.length === 4 ? n : de.shared.setValue(n).toArray() : n = _t;
      const i = ((_a = e.frame) == null ? void 0 : _a.copyTo(vt)) || je(s, gt).rectangle;
  ...
  class Ie {
    ...
    bind({ size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: s, offset: n }) {
      ...
      const c = d.uniforms;
      c.uProjectionMatrix = l.projectionMatrix, c.uResolution = l.resolution, c.uWorldTransformMatrix.copyFrom(l.worldTransformMatrix), c.uWorldTransformMatrix.tx -= l.offset.x, c.uWorldTransformMatrix.ty -= l.offset.y, Qe(l.worldColor, c.uWorldColorAlpha, 0), d.update();
      let h;
      this._renderer.renderPipes.uniformBatch ? h = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(d, false) : (h = this._bindGroupPool.pop() || new Ke(), this._activeBindGroups.push(h), h.setResource(d, 0)), l.bindGroup = h, this._currentGlobalUniformData = l;
    }
    push(e) {
  ...
  function bt(a) {
    if (!Z) {
      if (ce.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
        const e = [
          `%c  %c  %c  %c  %c PixiJS %c v${Y} (${a}) http://www.pixijs.com/
...
`,
      ...
      } else globalThis.console && globalThis.console.log(`PixiJS ${Y} - ${a} - http://www.pixijs.com/`);
      Z = true;
    }
  }
  class z {
  ...
  const j = class Oe {
    ...
    init(e) {
      e = {
        ...Oe.defaultOptions,
        ...e
      }, e.view && (Ye(Je, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new w(0, 0, e.width, e.height), this.canvas = e.canvas || ce.get().createCanvas(), this.antialias = !!e.antialias, this.texture = be(this.canvas, e), this.renderTarget = new I({
        colorTextures: [
          this.texture
        ],
        depth: !!e.depth,
    ...
    destroy(e = false) {
      (typeof e == "boolean" ? e : !!(e == null ? void 0 : e.removeView)) && this.canvas.parentNode && this.canvas.parentNode.removeChild(this.canvas);
    }
  };
  j.extension = {
    type: [
